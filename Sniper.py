...
parser = argparse.ArgumentParser(description='Set your Token and Amount example: "sniper.py -t 0x0A4A569cfA700Fc2A1d54974712716E537C169ff -a 0.2 -s 15"')
parser.add_argument('-t', '--token', help='str, Token for snipe e.g. "-t 0x0A4A569cfA700Fc2A1d54974712716E537C169ff"')
...
class SniperBot():
    ...
    def SayWelcome(self):
        ...
        print(style().GREEN +"""BSC SNIPER"""+ style().RESET)
    ...
    def parseArgs(self):
        ...
        if self.token == None:
            print(style.RED+"Please Check your Token argument e.g. -t 0x0A4A569cfA700Fc2A1d54974712716E537C169ff")
            print("exit!")
            sys.exit()
